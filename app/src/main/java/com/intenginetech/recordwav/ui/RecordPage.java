...
import com.intenginetech.recorder.recording.AudioRecordConfig;
import com.intenginetech.recorder.recording.MsRecorder;
import com.intenginetech.recorder.recording.PullTransport;
import com.intenginetech.recorder.recording.Recorder;
...
import com.intenginetech.recordwav.utils.DateUtils;
...
public class RecordPage extends BaseFragment {
    ...
    @BindView(R.id.bt_noise_reduction) Button bt_noise_reduction;
...
//        bt_pause_resume.setEnabled(false);
        bt_noise_reduction.setEnabled(false);
...
//                    bt_pause_resume.setEnabled(false);
                    bt_stop.setEnabled(false);
                    bt_noise_reduction.setEnabled(true);
//                    bt_pause_resume.setText(getString(R.string.pause));
        ...
        bt_noise_reduction.setOnClickListener(new View.OnClickListener(){

            @Override
            public void onClick(View view) {
                T.showShort(mContext, "暂未实现该功能");
            }
        });
